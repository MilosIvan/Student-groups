...
public class UkloniZabavuController {
    ...
    public void ukloniButton() {
        try {
            ...
            dialog.setHeaderText("Ukloni zabavu");
            ...
            if(result.isPresent()) {
                if(result.get() == ButtonType.OK) {
                    ...
                    Database.ukloniDogadaj("ZABAVE", id);

                    Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
                    alert.setTitle("Pokušaj uspješan");
                    alert.setHeaderText("Uspješno ste uklonili zabavu");
                    alert.showAndWait();

                    Promjena promjena = new Promjena(
                            "Uklonjena zabava " + zabava.getNaziv(),
                            zabava.getId(),
            ...
            ApplicationProject.logger.error("Nepotpun unos podataka prilikom uklanjanja zabave");
            ...
            ApplicationProject.logger.error("Number format exception prilikom uklanjanja zabave");
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Pokušaj neuspješan");
            ...
            ApplicationProject.logger.error("Unesen nepostojeći ID prilikom uklanjanja zabave");
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Pokušaj neuspješan");
