...
public class UkloniProjektController {
    @FXML
    ...
    public void ukloniButton() {
        try {
            ...
            dialog.setHeaderText("Ukloni projekt");
            ...
            if(result.isPresent()) {
                if(result.get() == ButtonType.OK) {
                    ...
                    Database.ukloniDogadaj("PROJEKTI", id);

                    Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
                    alert.setTitle("Pokušaj uspješan");
                    alert.setHeaderText("Uspješno ste uklonili projekt");
                    alert.showAndWait();

                    Promjena promjena = new Promjena(
                            "Uklonjen projekt " + projekt.getNaziv(),
                            projekt.getId(),
            ...
            ApplicationProject.logger.error("Nepotpun unos podataka prilikom uklanjanja projekta");
            ...
            ApplicationProject.logger.error("Number format exception prilikom uklanjanja projekta");
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Pokušaj neuspješan");
            ...
            ApplicationProject.logger.error("Unesen nepostojeći ID prilikom uklanjanja projekta");
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Pokušaj neuspješan");
